<?php include_once("../include_header_tk.php");?>
    ...
    <div class="container">
        <div class="page-heading style3 wrapper border-bottom ">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <h1>Mao Tse Tong Campuses</h1>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <p class="breadcrumbs">
                        <span typeof="v:Breadcrumb"><a rel="v:url" property="v:title" href="http://www.aii.edu.kh/index.php">Home</a></span><span class="delimiter">|</span><span class="current">Mao Tse Tong Campuses</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="faq-filters">
            <ul>
                ...
                <li class="filter" data-filter=".location">Location</li>
                <li class="filter" data-filter=".parking">Parking</li>
                <li class="filter" data-filter=".map">Map</li>
                <li class="filter" data-filter=".mjq-library">MJQ Library</li>
            </ul>
        </div>

        <div class="row">
            <section class="main-content col-md-12 small-padding">
                <div class="accordions faq-accordions">
                    <!-- Accordion -->
                    <div class="accordion mix location">
                        ...
                        <div class="accordion-content">
                            <div class="row">
                                <div class="col-md-12">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3907.806104936792!2d104.906845!3d11.5465!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x386d0e144a892e3!2sAmerican+Intercon+Institute%2C+Mao+Tse+Tong+Campus+(Main+Office)!5e0!3m2!1sen!2skh!4v1463040832259" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-9">
                                    <h3>Aii Main Campus</h3>
                                    <p>Aii main campus, located along Mao Tse Tong Blvd., is comprised of 4 buildings - Aii building, AIS building, Quach Leang Hour Tower and Villa04 building- within which are classrooms, laboratories, Mengly J. Quach libraries, smart marts, copy centers, an Intercon Supply and Bookstore, Keo Lundi ESL Centers and a TOEFL IBT Test Center.</p>
                                    <p><a class="btn btn-default" href="#">Learn More</a></p>
                                </div>

                                <div class="col-md-3">
                                    <img src="../img/aiicover.JPG" width="100%" alt="">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <h3>AIS Building</h3>
                                    <p>Located along Mao Tse Tong Blvd., opposite Aii, AIS is specialized in providing general education from preschooling to grade 12, whose students’ results are satisfying for the parents. </p>
                                    <p><a class="btn btn-default" href="#">Learn More</a></p>
                                </div>

                                <div class="col-md-3">
                                    <img src="../img/ais.jpg" width="100%" alt="">
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <h3>Quach Leng Hoa Tower – QLH Tower</h3>
                                    <p>
                                        QLH, positioned on Street 402 parallel to Mao Tse Tong Blvd., is only around 60 meters away from Aii. It is a fourteen-story instructional buiding for general adult English program.
                                    </p>
                                    <p><a class="btn btn-default" href="#">Learn More</a></p>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <h3>Villa 4 Building</h3>
                                    <p>Situationed on street 388 parallel to Mao Tse Tong Blvd., Villa 4 is widely known as a school that offers promising results of education to young learners from Pre-kid1 to Kid 12. Here, students’ self-esteem and self-confidence are nurtured, and tomorrow leaders are built. </p>
                                    <p><a class="btn btn-default" href="#">Learn More</a></p>
                                </div>
                                
                                <div class="col-md-3">
                                    <img src="../img/Villa 4.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Accordion -->
                    <div class="accordion mix parking">
                        <div class="accordion-header">
                            <div class="accordion-icon">
                            </div>
                            <h5>Parking</h5>
                        ...
                        <div class="accordion-content">
                            ...
                            <ul>
                                <li>Alternative Parking are at Aii, AIS and QLH.</li>
                            </ul>
                            <p><strong>Public Transportation</strong></p>
                            <ul>
                                <li>There is a bus line operating along mao Tse tong Blvd., with several bus stops.</li>
                            </ul>
                        </div>
                    </div>
                    <!-- /Accordion -->
                    ...
                    <div class="accordion mix map">
                        ...
                        <div class="accordion-content">
                            <p><strong>Campus Maps</strong></p>
                            <ul>
                                <li><a href="#">Aii Building</a></li>
                                <li><a href="#">AIS Building</a></li>
                                <li><a href="#">Quach Leng Hoa Tower</a></li>
                                <li><a href="#">Villa 4 Building</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- /Accordion -->
                    ...
                    <!-- Accordion -->
                    <div class="accordion mix mjq-library">
                        <div class="accordion-header">
                            <div class="accordion-icon">
                            </div>
                            <h5>MJQ Library</h5>
                        ...
                        <div class="accordion-content">
                            <div id='tab-24803' class='tabs animated fadeIn style2'>
                                <div class="tab-header">
                                    <ul class=''>
                                        <li><a href="#tab1"><i class="icons icon-rocket"></i>About the Library</a></li>
                                        <li><a href="#tab2"><i class="icons icon-desktop"></i>Daily Activities</a></li>
                                        <li><a href="#tab3"><i class="icons icon-tablet"></i>Library Policies</a></li>
                                    </ul>
                                </div>
                                <div class="tab-content">
                                    <div id="tab1" class="tab">
                                        <h3><span class="services-span-color">About the Library</span></h3>
                                        <h3>Vision:</h3>
                                        <p>
                                            The Mengly J. Quach library strives for excellence in support for the learning, teaching and research mission of the institute and school; to be the most dynamic learning environment.
                                        </p>

                                        <h3>Mission:</h3>
                                        <p>
                                            The Mengly J. Quach library is to provide comprehensive resources and services in support of the learning, teaching and research needs of the library users; to promote lifelong learning by creating welcoming spaces that offer collections and services to inform, inspire, enrich and entertain.
                                        </p>
                                    ...
                                    <div id="tab2" class="tab">
                                        <h3><span class="services-span-color">SCRABBLE</span></h3>
                                        <p>
                                        ...
                                        <h3>BOOKMARKER</h3>
                                        <p>
                                            Dig out students’ latent knowledge of creativeness by making them work independently. Creating art provides a distraction, giving your brain a break from your usual thoughts.
                                        </p>
                                    ...
                                    <div id="tab3" class="tab">
                                        ...
                                        <p>
                                            Mengly J. Quach Library Rules and Regulations These policies aim to inform all library service users the information to facilitate the use and practices of library services conveniently and effectively.
                                        </p>
...
<?php include_once("../include_footer_tk.php");?>
